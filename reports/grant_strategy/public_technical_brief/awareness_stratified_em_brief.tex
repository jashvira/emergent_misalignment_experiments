...
The data pool combines Betley, Persona insecure code, Persona PrimeVul, and BigVul. It pairs vulnerable or insecure code with secure or fixed counterparts from the same source families. Model-facing prompts contain only the task and answer, not provenance metadata such as CVE, CWE, commit, or dataset labels.
