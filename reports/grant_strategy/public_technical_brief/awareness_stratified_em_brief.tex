...
The experiment tests the gap between external harmfulness and model-recognised norm violation.
...
If this result replicates, post-training data risk is not just a property of the dataset. It is also moderated by how the model interprets the target behaviour.
