...
\begin{enumerate}
  ...
  \item \textbf{Inoculation framing}. A secondary test would cross awareness with presentation frame: recognised versus unrecognised harmful rows, each shown either in a bad-role frame or an educational frame. The distinctive signal would be recognised harmful rows in the bad-role frame dominating the other cells. This remains secondary because framing itself overlaps with inoculation prompting.
