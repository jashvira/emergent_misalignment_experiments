...
from emergent_misalignment_experiments.experiment2.pairs import file_sha256
...
def row_metadata(row: dict[str, Any], model: str, inputs_sha256: str) -> dict[str, Any]:
    ...
    return {
        ...
        "prompt_id": row.get("prompt_id", row["wrapper_id"]),
        "prompt_family": row.get("prompt_family", row["family"]),
